...
On approval, update the GitHub issue by appending \`## Implementation plan\` with the final plan. Use \`gh issue edit\` or \`gh issue comment\` — whichever fits. Do NOT git commit.
