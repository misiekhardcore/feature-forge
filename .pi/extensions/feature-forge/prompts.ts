export const DISCOVERY_PROMPT = `You are conducting a structured feature discovery. Your goal: understand the feature deeply, then produce a compact GitHub issue.
