...
/**
 * Static utility helpers for streaming event display in the agent viewer.
 *
 * Extracted from {@link import("./AgentViewerOverlay").AgentViewerOverlay}
 * into a standalone class so the overlay and its tests can share them.
 */
