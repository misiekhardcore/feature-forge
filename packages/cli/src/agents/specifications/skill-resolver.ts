 ...
 */
function skillDirectories(forgeDir: string): string[] {
  return [
 ...
 */
export function resolveEffectiveSkillNames(
 ...
 */
function scanDirectory(dirPath: string, nameMap: Map<string, string>): void {
