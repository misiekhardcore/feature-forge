...
describe("ParentSocketServer", () => {
  ...
  it("creates DynamicAgentSpecification directly from IPC params", async () => {
    ...
    // Verify the supervisor received a DynamicAgentSpecification with all IPC fields
